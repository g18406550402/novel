...
<script src="http://cdn.highcharts.com.cn/highcharts/highcharts.js"></script>
  ...
  <link rel="stylesheet" href="css/bootstrapSwitch/css/bootstrap3/bootstrap-switch.min.css">
   ...
   <link rel="stylesheet" href="http://localhost:8080/css/bootstrap-3.3.7/css/bootstrap.min.css">
  ...
  <style src="http://localhost:8080/layui/css/index.css"></style>
  <style type="text/css">
    #inner p:first-child{
    margin-left: 300px;
    margin-top: 110px;
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
     ...
     <div class="layui-logo" style="font-size:18px;font-weight:bolder;">buke管理系统</div>
